class ApiConfig {
  ...
  // ESTUDIANTE
  static const String recuperarPasswordEstudiante =
      '$baseUrl/estudiante/recuperarpassword';
  static String comprobarTokenEstudiante(String token) =>
      '$baseUrl/estudiante/recuperarpassword/$token';
  static String nuevoPasswordEstudiante(String token) =>
      '$baseUrl/estudiante/nuevopassword/$token';

  // DOCENTE
  static const String recuperarPasswordDocente =
      '$baseUrl/docente/recuperarpassword';
  static String comprobarTokenDocente(String token) =>
      '$baseUrl/docente/recuperarpassword/$token';
  static String nuevoPasswordDocente(String token) =>
      '$baseUrl/docente/nuevopassword/$token';

  // ADMINISTRADOR
  static const String recuperarPasswordAdmin =
      '$baseUrl/administrador/recuperarpassword';
  static String comprobarTokenAdmin(String token) =>
      '$baseUrl/administrador/recuperarpassword/$token';
  static String nuevoPasswordAdmin(String token) =>
      '$baseUrl/administrador/nuevopassword/$token';

  // ========== CAMBIO DE CONTRASEÑA OBLIGATORIO ==========

  // ⭐ NUEVO: Para docentes recién creados con contraseña temporal
  static const String cambiarPasswordObligatorioDocente =
      '$baseUrl/docente/cambiar-password-obligatorio';
  ...
  // Actualizar perfil
  static String actualizarPerfilAdmin(String id) =>
      '$baseUrl/administrador/$id';
  static String actualizarPerfilDocente(String id) =>
      '$baseUrl/docente/perfil/$id';
  static String actualizarPerfilEstudiante(String id) =>
      '$baseUrl/estudiante/$id';

  // Actualizar contraseña
  static String actualizarPasswordAdmin(String id) =>
      '$baseUrl/administrador/administrador/actualizarpassword/$id';
  static String actualizarPasswordDocente(String id) =>
      '$baseUrl/docente/actualizarpassword/$id';
  static String actualizarPasswordEstudiante(String id) =>
      '$baseUrl/estudiante/actualizarpassword/$id';
  ...
  static String actualizarTutoria(String id) =>
      '$baseUrl/tutoria/actualizar/$id';
  static String cancelarTutoria(String id) => '$baseUrl/tutoria/cancelar/$id';
  static String registrarAsistencia(String id) =>
      '$baseUrl/tutoria/registrar-asistencia/$id';

  // ========== ENDPOINTS DE DISPONIBILIDAD ==========

  static const String registrarDisponibilidad =
      '$baseUrl/tutorias/registrar-disponibilidad';
  static String verDisponibilidad(String docenteId) =>
      '$baseUrl/ver-disponibilidad-docente/$docenteId';
  static String bloquesOcupados(String docenteId) =>
      '$baseUrl/tutorias-ocupadas/$docenteId';
